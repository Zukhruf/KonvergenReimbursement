  ...
  <body>
    ...
    <div class="container-fluid ms-auto me-auto" id="bodyContent">
      ...
      <div class="d-flex">
        ...
        <button type="button" class="btn btn-outline-primary shadow ms-auto me-1 mb-2 rounded" name="buttonHapusReimbursement" id="btnHapusFilter" data-bs-toggle="modal" data-bs-target="#modalHapusReimbursement"><i class="fas fa-trash-alt me-2"></i>HAPUS REIMBURSEMENT</button>
      </div>
